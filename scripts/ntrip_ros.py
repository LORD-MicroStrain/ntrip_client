        ...
        if rtcm_message_package == _RTCM_MSGS_NAME:
            if have_rtcm_msgs:
                ...
                self.get_logger().fatal(
                    "The requested RTCM package {} is a valid option, but we were unable to import it. Please make sure you have it installed".format(
            ...
            self.get_logger().fatal(
                "The RTCM package {} is not a valid option. Please choose between the following packages {}".format(
